  ...
  return (
    <div className="rounded-[10px] border border-[#EDF1F6] bg-white px-4 py-5">
      <div className="mb-2.5 flex items-center gap-2">
        <span className="shrink-0 text-[10px] font-bold uppercase tracking-wide text-[#5B6472]">Netz</span>
        {modell === "physischer_sz" && (
          <div className="flex h-7 shrink-0 items-center justify-center rounded-md border-2 border-[#3AA8DC] bg-[#EAF6FC] px-2.5 text-[11px] font-bold text-[#1B2A3A]">
            Z1
          </div>
        )}
        <div className="h-px flex-1 bg-[#3AA8DC]" />
      </div>

      {modell === "virtueller_sz" ? (
