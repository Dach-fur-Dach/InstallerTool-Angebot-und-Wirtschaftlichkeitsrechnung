      ...
      {angebotReady ? (
        <div style={{ opacity: dashboardOpacity, transition: "opacity 0.25s ease" }}>
          ...
          <div className="mb-1 grid grid-cols-[1.6fr_0.8fr_0.7fr_0.8fr] gap-x-2 gap-y-1.5 text-[12.5px] text-[#1B2A3A]">
            ...
            <div className="pl-1 text-[#5B6472]">1x Zähler Allgemeinstrom</div>
            ...
            <div className="pl-1 text-[#5B6472]">0x Funkadapter für Zähler</div>
            <div className="text-right">0,00 €</div>
            <div className="text-right text-[#98A2B3]">0,00 €</div>
            <div className="text-right">0,00 €</div>
          </div>
