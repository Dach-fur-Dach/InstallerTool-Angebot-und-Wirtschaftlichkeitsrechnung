...
import type { OutputsState } from "@/hooks/useMieterstromCalculator";
...
export function PrintCoverPage({ outputs }: { outputs: OutputsState }) {
  ...
  return (
    <div className="break-after-page isolate relative flex h-[296mm] flex-col justify-between p-[14mm_12mm]">
